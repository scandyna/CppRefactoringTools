...
**
*****************************************************************************************/
#ifndef MDT_CPP_REFACTORING_QRUNTIME_ERROR_H
#define MDT_CPP_REFACTORING_QRUNTIME_ERROR_H
...
namespace Mdt{ namespace CppRefactoring{
   ...
   * Usage example:
   * \code
   * class SOME_EXPORT MyError : public QRuntimeError
   * {
   *  public:
   *
   *    explicit MyError(const QString & text)
   *     : QRuntimeError(text)
   *    {
   *    }
   * };
   ...
   */
  class MDT_CPPREFACTORING_EXPORT QRuntimeError : public std::runtime_error
  {
   public:
    ...
    /*! \brief Constructor
     */
    explicit QRuntimeError(const QString & text)
...
#endif // #ifndef MDT_CPP_REFACTORING_QRUNTIME_ERROR_H
